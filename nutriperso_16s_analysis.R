...
GP.ord <- ordinate(nutri, "NMDS", "bray")
plot_ordination(nutri, GP.ord, type="taxa", color="Phylum", title="taxa")

# Plot of samples
plot_ordination(nutri, GP.ord, type="samples", color="casnutpkt", shape="diabete_groupe")
